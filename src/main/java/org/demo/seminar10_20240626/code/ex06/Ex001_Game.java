package org.demo.seminar10_20240626.code.ex06;
...
public class Ex001_Game {
    public static void main(String[] args) {
        ...
        team1.add(JavaTeam.CreateEmployee(0));
        team1.add(JavaTeam.CreateEmployee(0));
        System.out.println(team1);

        Team team2 = new Team("Хлебушки ");
        team2.add(JavaTeam.CreateEmployee(0));
        team2.add(JavaTeam.CreateEmployee(0));
        team2.add(JavaTeam.CreateEmployee(1));
